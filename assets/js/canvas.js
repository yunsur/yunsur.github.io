window.onload = function () {
    var eid = "content"
    document.getElementById(eid).style.margin = "0";
    // document.getElementById(eid).style.background = "#30333F";
    //创建 canvas 画布
    document.getElementById(eid).appendChild(document.createElement('canvas'));
    var canvas = document.querySelector('canvas'),
        ctx = canvas.getContext('2d') //ctx 返回一个在canvas上画图的api/dom
